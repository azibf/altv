    ...
    if form.validate_on_submit():
        try:
            ...
            return render_template(
                "login.html", message="Ошибка авторизации", form=form
            )
...
def addPool():
    ...
    return render_template(
        ...
        title="Создание пула",
        form=form,
        nodes=nodes(current_user.ip, current_user.username, current_user.password),
    )
